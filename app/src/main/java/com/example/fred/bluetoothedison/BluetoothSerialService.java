...
public class BluetoothSerialService {
    ...
    /**
     * Start the IOThread to begin SPP IO
     *
     * @param socket The BluetoothSocket on which the connection was made
     * @param device The BluetoothDevice that has been connected
     */
    public synchronized void startIOThread(BluetoothSocket socket, BluetoothDevice
            device) {
        Log.d(TAG, "connected");
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Constants.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Constants.TOAST, "mBTDevice connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                tmp = device.createRfcommSocketToServiceRecord(SVC_UUID);
        ...
        public void run() {
            ...
            startIOThread(mmSocket, mmDevice);
        }
